 ...
 */
Object.defineProperty( Natives.Document.prototype, 'xmlns', {
	get: function()
	{
...
Natives.Document.prototype._createStyleImpl = ShadowRoot.prototype._createStyleImpl = function()
{
	var _impl;
...
Object.defineProperty( Natives.Document.prototype, 'isHtml5', {
	get: function()
	{
 ...
 */
Natives.Document.prototype.preinitialize = ShadowRoot.prototype.preinitialize = function( root )
{
 ...
 * @param {Element} root Optional: The node from witch loop on all children, otherwise the Document.
 */
Natives.Document.prototype.initialize = ShadowRoot.prototype.initialize = function( root )
{
...
{
	return this.createElementNS( this.lookupNamespaceURI(null), nodeName );//.extends()
}
Natives.Document.prototype.loadComponent = ShadowRoot.prototype.loadComponent = function( node, ext )
{
	if( !node.Class )
...
Natives.Document.prototype.onComponentLoaded = ShadowRoot.prototype.onComponentLoaded = function( node, doc )
{
	doc.initialize();
