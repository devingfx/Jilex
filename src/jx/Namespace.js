(function( doc ){
	...
	window.Namespace = function Namespace( prefix, URI )
    {
    	if( !arguments.length )
    		return;
     ...
     */
    Namespace.prototype.toUrl = function()
    {
	...
	Object.defineProperty( Namespace.prototype, 'url', {
		enumerable: true,
		get: function()
		{
			return this.toUrl();
	...
	Namespace.prototype.loadManifest = function( force )
	{
		var _this = this,
	...
	Namespace.prototype.onManifestLoaded = function( xml )
	{
		var _this = this;
		this.manifest = xml;
	...
	Namespace.prototype.parseManifest = function()
	{
		var _this = this;
		if( this.manifest )
		{
    ...
    Namespace.prototype.import = function( thing, cb )
    {
	...
	Namespace.prototype._importFromComponentNode = function( comp, cb )
	{
 ...
 //   Namespace.prototype._importFromLocalPackage = function( pack, cb )
	// {
	...
	// };
    Namespace.prototype._importFromClassName = function( className, cb )
	{
    ...
    Namespace.prototype._importFromUrl = function( url, cb )
	{
